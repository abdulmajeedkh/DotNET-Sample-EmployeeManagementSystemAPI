...
namespace EmployeeManagement.API.Controllers
{
    ...
    public class TrainingController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(TrainingDto dto) => Ok(await _svc.CreateAsync(dto));

        [HttpPut]
        public async Task<IActionResult> Update(TrainingDto dto) => Ok(await _svc.UpdateAsync(dto));
